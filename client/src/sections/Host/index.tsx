...
import { LoadingOutlined, PlusOutlined, BankOutlined, HomeOutlined } from "@ant-design/icons";
...
export const Host = ({ viewer }: Props) => {
  ...
  return (
    <Content className="host-content">
      <Form layout="vertical" onFinish={handleHostListing} onFinishFailed={onFinishFailed} name="host_form" form={form}>
        <div className="host__form-header">
          <Title level={3} className="host__form-title">
