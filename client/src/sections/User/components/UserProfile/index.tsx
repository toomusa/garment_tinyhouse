...
const stripeAuthUrl = `https://connect.stripe.com/express/oauth/authorize?client_id=${process.env.REACT_APP_S_CLIENT_ID}&scope=read_write`
      ...
      onCompleted: data => {
        if (data && data.disconnectStripe) {
          ...
          displaySuccessNotification(
            "You have successfully disconnected Stripe.",
